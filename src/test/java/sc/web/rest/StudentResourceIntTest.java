...
public class StudentResourceIntTest {
    ...
    private static final String DEFAULT_SSPECIAL = "AAAAAAAAAA";
    private static final String UPDATED_SSPECIAL = "BBBBBBBBBB";

    private static final String DEFAULT_SCLASS = "AAAAAAAAAA";
    private static final String UPDATED_SCLASS = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .sname(DEFAULT_SNAME)
            .ssex(DEFAULT_SSEX)
            .sspecial(DEFAULT_SSPECIAL)
            .sclass(DEFAULT_SCLASS);
        return student;
    }
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getSsex()).isEqualTo(DEFAULT_SSEX);
        assertThat(testStudent.getSspecial()).isEqualTo(DEFAULT_SSPECIAL);
        assertThat(testStudent.getSclass()).isEqualTo(DEFAULT_SCLASS);
    }
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sspecial").value(hasItem(DEFAULT_SSPECIAL.toString())))
            .andExpect(jsonPath("$.[*].sclass").value(hasItem(DEFAULT_SCLASS.toString())));
    }
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.sspecial").value(DEFAULT_SSPECIAL.toString()))
            .andExpect(jsonPath("$.sclass").value(DEFAULT_SCLASS.toString()));
    }
    ...
    public void updateStudent() throws Exception {
        ...
        updatedStudent
            ...
            .sname(UPDATED_SNAME)
            .ssex(UPDATED_SSEX)
            .sspecial(UPDATED_SSPECIAL)
            .sclass(UPDATED_SCLASS);
        ...
        assertThat(testStudent.getSsex()).isEqualTo(UPDATED_SSEX);
        assertThat(testStudent.getSspecial()).isEqualTo(UPDATED_SSPECIAL);
        assertThat(testStudent.getSclass()).isEqualTo(UPDATED_SCLASS);
    }
