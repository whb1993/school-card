...
import sc.config.audit.AuditEventConverter;
import sc.domain.PersistentAuditEvent;
...
import static sc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
